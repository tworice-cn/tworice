<template>
      <div class="app-body">
            <el-col :span="24" class="department">
                  <el-col :span="24" class="department-main">
                        <el-col :span="12" class="department-list">
                              ...
                              <el-col :span="24" class="department-content">
                                    <el-col :span="24" class="department-add">
                                          <el-button size="mini" type="primary" icon="el-icon-plus" @click.native="editDepartment({id:-1,departmentName:''},2)">添加部门</el-button>
                                    </el-col>
                                    <el-col :span="24">
                                          <el-table size="mini" class="department-table" :header-cell-style="$setting.table_header" v-loading="departmentLoad" :data="departments" style="width: 100%" ref="departmentTable" highlight-current-row @current-change="handleCurrentChange">
                                                <el-table-column prop="departmentName" label="部门名称"></el-table-column>
                                                <el-table-column label="操作">
                                                      <template slot-scope="scope">
                                                            <el-tooltip content="编辑">
                                                                  <el-button size="mini" icon="el-icon-edit" @click.native="editDepartment(scope.row,1)" type="info" circle></el-button>
                                                            </el-tooltip>
                                                            <el-tooltip content="删除">
                                                                  <el-button size="mini" icon="el-icon-delete" @click.native="delDepartment(scope.row)" type="danger" circle></el-button>
                                                            </el-tooltip>
                                                            <el-tooltip content="调动记录">
                                                                  <el-button size="mini" icon="el-icon-view" @click.native="showLog(scope.row)" type="primary" circle></el-button>
                                                            </el-tooltip>
                                                      </template>
                                                </el-table-column>
                                          </el-table>
                        ...
                        <el-col :span="12" class="department-setUser">
                              ...
                              <el-col :span="24" class="department-content" v-if="currentDepartment">
                                    <el-col :span="24"  class="department-add">
                                          <el-button size="mini" type="primary" icon="el-icon-edit" @click.native="addUser">设置人员</el-button>
                                    </el-col>
                                    <el-col :span="24">
                                          <el-table :header-cell-style="$setting.table_header" v-loading="adminLoad" empty-text="当前部门无人员" :data="admins" style="width: 100%" ref="departmentTable">
                  ...
                  <!-- 弹出层 -->
                  <el-dialog :title="'当前部门：'+this.currentDepartment.departmentName" :visible.sync="addUserDialog" width="50%" :before-close="$utils.handleClose">
                  ...
                  <el-dialog title="调动记录" :visible.sync="resourceDialog" width="60%" top="5vh" :before-close="$utils.handleClose">
                  ...
                  <el-dialog title="设置部门" :visible.sync="departmentDialog" width="40%" :before-close="$utils.handleClose">
                        ...
                        <el-input v-model="departmentForm.departmentName" placeholder="请输入部门名" maxlength="8" show-word-limit></el-input>

                        <span slot="footer" class="dialog-footer">
                              <el-button @click="departmentDialog = false" type="primary" @click.native="submitDepartment">确 认</el-button>
                        </span>
                  </el-dialog>
            </el-col>
      </div>
