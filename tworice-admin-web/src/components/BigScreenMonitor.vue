        ...
        <el-col :span="24" class="chart-box">
            <el-col :span="7" class="min-height left-box">
                <el-col :span="24" class="min-height chart-item-box chart-1">
                    <el-col :span="24" class="chart-title">系统内存 <i class="el-icon-view"
                                                                       @click="toPage('/tools/monitor')"></i></el-col>
                    <el-col :span="24" class="chart-item" id="chart-1"></el-col>
                </el-col>
                <el-col :span="24" class="min-height chart-item-box chart-2">
                    <el-col :span="24" class="chart-title">登录异常 <i class="el-icon-view"
                                                                       @click="toPage('/log/loginLog')"></i></el-col>
            ...
            <el-col :span="10" class="min-height left-box">
                <el-col :span="24" class="min-height chart-item-box chart-3">
                    <el-col :span="24" class="chart-title">在线人数 <i class="el-icon-view"
                                                                       @click="toPage('/tools/online')"></i></el-col>
                ...
                <el-col :span="24" class="min-height chart-item-box chart-4">
                    <el-col :span="24" class="chart-title">操作异常 <i class="el-icon-view"
                                                                       @click="toPage('/log/log')"></i></el-col>
                ...
                <el-col :span="24" class="min-height chart-item-box chart-5">
                    <el-col :span="24" class="chart-title">最新获得管理员权限账户 <i class="el-icon-view"
                                                                                     @click="toPage('/system/role')"></i>
                    </el-col>
            ...
            <el-col :span="7" class="min-height left-box">
                <el-col :span="24" class="min-height chart-item-box chart-6">
                    <el-col :span="24" class="chart-title">流量监控 <i class="el-icon-view"
                                                                       @click="toPage('/tools/admin')"></i></el-col>
...
export default {
    ...
    data() {
        return {
            currentTime: "2024/03/22 18:17:19",
            online: 1,
            adminLog: [],
            admin: [],
            echarts1: "",
