            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    ...
                    <el-tooltip content="重置密码">
                        <el-button size="mini" type="primary" icon="el-icon-refresh" circle
                                   @click.native="rePassWord(scope.row)"></el-button>
                    </el-tooltip>
        ...
        <el-dialog :title="formTitle" :visible.sync="formVisible" width="40%" :before-close="$utils.handleClose">
            <el-form :model="form" size="mini" :rules="rules" ref="form">
                <el-form-item label="用户名称" :label-width="formLabelWidth" prop="nickName">
                    <el-input placeholder="请输入内容" v-model="form.nickName" @change="isChange = true"
                              :disabled="showAdmin"></el-input>
                </el-form-item>
                <el-form-item label="登录账号" :label-width="formLabelWidth" prop="loginName">
                    <el-input placeholder="请输入内容" v-model="form.loginName" @change="isChange = true"
                              :disabled="showAdmin"></el-input>
                </el-form-item>
        ...
        show(row) {
            ...
            this.$axios({
                ...
                arrValue.push({
                    icon: 'el-icon-male',
                    name: '性别',
                    value: this.adminInfo.adminSex == 1 ? '男' : this.adminInfo.adminSex == 0 ? '女' : '未知'
                });
