      ...
      <div class="app-body">
            <el-col :span="24" class="role">
                  <el-col :span="24" class="role-main">
                        <el-col :span="12" class="role-list">
                              ...
                              <el-col :span="24" class="role-content">
                                    <el-col :span="24" class="role-add">
                                          <el-button size="mini" type="primary" icon="el-icon-plus" @click.native="editRole({id:-1,roleName:''},2)">添加角色</el-button>
                                    </el-col>
                                    <el-col :span="24">
                                          <el-table size="mini" class="role-table" :header-cell-style="$setting.table_header" v-loading="roleLoad" :data="roles" style="width: 100%" ref="roleTable" highlight-current-row @current-change="handleCurrentChange">
                                                <el-table-column prop="roleName" label="角色名称"></el-table-column>
                                                <el-table-column label="操作">
                                                      <template slot-scope="scope">
                                                            <el-tooltip content="权限管理">
                                                                  <el-button size="mini" type="primary" icon="el-icon-set-up" @click.native="editResource(scope.row)" circle></el-button>
                                                            </el-tooltip>
                                                            <el-tooltip content="编辑">
                                                                  <el-button size="mini" icon="el-icon-edit" @click.native="editRole(scope.row,1)" type="info" circle></el-button>
                                                            </el-tooltip>
                                                            <el-tooltip content="删除">
                                                                  <el-button size="mini" icon="el-icon-delete" @click.native="delRole(scope.row)" type="danger" circle></el-button>
                                                            </el-tooltip>
                                                      </template>
                                                </el-table-column>
                                          </el-table>
                        ...
                        <el-col :span="12" class="role-setUser">
                              ...
                              <el-col :span="24" class="role-content" v-if="currentRole">
                                    ...
                                    <el-col :span="24">
                                          <el-table :header-cell-style="$setting.table_header" v-loading="adminLoad" empty-text="当前角色无人员" :data="admins" style="width: 100%" ref="roleTable">
                  ...
                  <el-dialog title="设置角色" :visible.sync="roleDialog" width="40%" :before-close="$utils.handleClose">
                        ...
                        <span slot="footer" class="dialog-footer">
                              <el-button @click="roleDialog = false" type="primary" @click.native="submitRole">确 认</el-button>
                        </span>
                  </el-dialog>
            </el-col>
      </div>
