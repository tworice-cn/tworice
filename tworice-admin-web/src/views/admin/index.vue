                    ...
                    <div class="index-header-box">
                        ...
                        <div class="header-right">
                            ...
                            <el-tooltip class="item" effect="dark" content="首页" placement="bottom"
                                ...
                                <i class="el-icon-s-home" @click="$router.push('/admin/home')"></i>
                            </el-tooltip>
                            <div class="zhan"></div>
                            <!-- 刷新图标 -->
                            ...
                            <el-tooltip class="item" effect="dark" :content="isFullScreen?'退出全屏':'全屏'"
                                        placement="bottom">
                                <i class="iconfont" :class="isFullScreen?'icon-suoxiao':'icon-quanping'"
                                   @click="switchFullScreen"></i>
                            </el-tooltip>
                            <div class="zhan"></div>
                            <el-tag effect="dark" type="success" size="mini" class="role-box">
                                {{ roles.length == 0 ? '0' : roles[0].roleName }}
                            </el-tag>
                    ...
                    <div class="portal-avatar">
                        <el-tag class="username-box">
                            <el-dropdown placement="bottom" trigger="click" class="username-drop-down">
                                <i class="el-icon-arrow-down"></i>
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item v-if="loginStatus" icon="el-icon-user"
                                                      @click.native="showUser('/admin/userCenter')">个人中心
                                    </el-dropdown-item>
                                    <el-dropdown-item v-if="loginStatus" icon="el-icon-edit" @click.native="editPwd">
                                        修改密码
                                    </el-dropdown-item>
                                    <el-dropdown-item icon="el-icon-switch-button" :divided="loginStatus"
                                                      @click.native="exitSystem">{{
                                            loginStatus ? '安全退出' : '登 录'
                                        }}
                                    </el-dropdown-item>
