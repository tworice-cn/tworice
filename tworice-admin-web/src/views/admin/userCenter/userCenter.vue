        ...
        <el-col :span="24" class="top-box">
            <div class="avatar-box">
                ...
                <el-col :span="24" class="user-info">
                    ...
                    <div class="info-item el-icon-location"> {{ adminInfo.homePlace ? adminInfo.homePlace : '未知' }}
                    </div>
                </el-col>
            </div>
        </el-col>
...
<!--                                邀请链接-->
<!--                            </template>-->
<!--                            <el-tag v-if="inviteCode">{{ getInviteLink() }}</el-tag>-->
<!--                            <el-button v-else size="mini" type="primary" @click="getInviteCode">创建邀请码</el-button>-->
<!--                        </el-descriptions-item>-->
                        <el-descriptions-item>
                            <template slot="label">
        ...
        <el-dialog title="编辑我的信息" :visible.sync="formVisible" width="40%" :before-close="$utils.handleClose">
            <el-form :model="adminInfo">
                ...
                <el-form-item label='联系方式' :label-width='$setting.formLabelWidth'>
                    <el-input placeholder='请输入联系方式' v-model='adminInfo.adminPhone' @change='isChange = true'
                              size="small"></el-input>
                </el-form-item>
                <el-form-item label='居住地' :label-width='$setting.formLabelWidth'>
                    <el-input placeholder='请输入居住地' v-model='adminInfo.homePlace' @change='isChange = true'
                              size="small"></el-input>
                </el-form-item>
                <el-form-item label='联系地址' :label-width='$setting.formLabelWidth'>
                    <el-input placeholder='请输入联系地址' v-model='adminInfo.contactAddress' @change='isChange = true'
                              size="small"></el-input>
                </el-form-item>
