...
CREATE TABLE `system_resources`  (
  ...
  `state` tinyint NULL DEFAULT NULL COMMENT '展示状态',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `system_resources` VALUES (1, '系统管理', '/system', 0, 1, 'el-icon-setting', 1, NULL, NULL);
INSERT INTO `system_resources` VALUES (2, '信息管理', '/info', 0, 2, 'el-icon-s-data', 1, NULL, NULL);
INSERT INTO `system_resources` VALUES (3, '基础设施', '/infra', 0, 3, 'el-icon-chat-line-round', 1, NULL, NULL);
INSERT INTO `system_resources` VALUES (4, '角色管理', '/system/role', 1, 11, 'null', 2, '@/components/admin/role.vue', NULL);
INSERT INTO `system_resources` VALUES (5, '资源菜单', '/system/resource', 1, 12, 'null', 2, '@/components/admin/resource.vue', NULL);
INSERT INTO `system_resources` VALUES (23, '公告信息', '/infra/notice', 3, 31, '', 2, '@/components/admin/notice.vue', NULL);
INSERT INTO `system_resources` VALUES (26, '人员管理', '/system/admin', 1, 14, '', 2, '@/components/admin/admin.vue', NULL);
INSERT INTO `system_resources` VALUES (29, '日志管理', '/log', 0, 4, 'el-icon-document', 1, '@/components/admin', NULL);
INSERT INTO `system_resources` VALUES (30, '操作日志', '/log/log', 29, 41, '', 2, '@/components/admin/log.vue', NULL);
INSERT INTO `system_resources` VALUES (31, '登录日志', '/log/loginLog', 29, 42, '', 2, '@/components/admin/loginLog.vue', NULL);
INSERT INTO `system_resources` VALUES (32, '系统工具', '/tools', 0, 5, 'el-icon-box', 1, '@/components/admin', NULL);
INSERT INTO `system_resources` VALUES (33, '系统接口', '/tools/doc', 32, 51, '', 2, '@/components/admin/doc.vue', NULL);
INSERT INTO `system_resources` VALUES (34, '系统监控', '/tools/monitor', 32, 52, '', 2, '@/components/admin/monitor.vue', NULL);
INSERT INTO `system_resources` VALUES (35, '代码生成', '/tools/codeGeneration', 32, 55, '', 2, '@/components/admin/codeGeneration.vue', NULL);
INSERT INTO `system_resources` VALUES (65, '开发示例', '/dev', 0, 6, 'el-icon-s-cooperation', 1, '@/components/admin/online.vue', NULL);
INSERT INTO `system_resources` VALUES (66, '富文本组件', '/dev/editor', 65, 61, '', 2, '@/components/dev/editor.vue', NULL);
INSERT INTO `system_resources` VALUES (67, '跳转页面', '/dev/jump', 65, 62, '', 2, '@/components/dev/jump.vue', NULL);
INSERT INTO `system_resources` VALUES (75, '文件上传', '/dev/upload', 65, 63, '', 2, '@/components/dev/upload.vue', NULL);
INSERT INTO `system_resources` VALUES (78, '在线账户', '/tools/online', 32, 56, '', 2, '@/components/admin/online.vue', NULL);
INSERT INTO `system_resources` VALUES (80, '版本日志', '/log/versionLog', 29, 43, '', 2, '@/components/admin/versionLog.vue', NULL);
INSERT INTO `system_resources` VALUES (83, '字典管理', '/tools/dict', 32, 50, '', 2, '@/components/admin/dist.vue', NULL);
INSERT INTO `system_resources` VALUES (94, '支付示例', '/dev/alipay/10086', 65, 4, '', 2, '@/components/dev/alipay.vue', NULL);
INSERT INTO `system_resources` VALUES (95, '访问白名单', '/tools/whiteList', 32, 57, '', 2, '@/components/admin/whiteList.vue', NULL);
INSERT INTO `system_resources` VALUES (96, 'AES加密', '/dev/aes', 65, 97, '', 2, '@/components/dev/aes.vue', NULL);
INSERT INTO `system_resources` VALUES (97, '我的文件', '/admin/file', 0, 9, 'el-icon-folder', 2, '@/components/admin/systemFile.vue', NULL);
INSERT INTO `system_resources` VALUES (99, 'OCR识别', '/dev/ocr', 65, 98, '', 2, '@/components/dev/ocr.vue', NULL);
INSERT INTO `system_resources` VALUES (101, '首页', '/admin/home', 0, -1, 'el-icon-s-home', 2, '@/components/admin', NULL);
INSERT INTO `system_resources` VALUES (102, '应用监控', '/tools/admin', 32, 58, '', 2, '@/components/tools/SpringBootAdmin.vue', NULL);
INSERT INTO `system_resources` VALUES (103, '部门管理', '/system/department', 1, 24, '', 2, '@/components/admin/department.vue', NULL);
INSERT INTO `system_resources` VALUES (106, '用户反馈', '/infra/feedback', 3, 3, '', 2, NULL, NULL);
INSERT INTO `system_resources` VALUES (107, '反馈类型', '/infra/feedbackType', 3, 1, '', 2, NULL, NULL);
INSERT INTO `system_resources` VALUES (115, 'Netty', '/dev/ws', 65, 10, '', 2, NULL, NULL);
...
INSERT INTO `system_user` VALUES ('cfe8f30c3992bd2bda10b36d59ccefc0', 'zhangsan', '033e997f49e0cff004e70b09303f670a', '张三', 1, 1713406355355, 1713848076414, 0, '1');
