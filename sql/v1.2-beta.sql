...
-- ----------------------------
INSERT INTO `system_operation_log` VALUES ('60ef18dc4a4b4a06aaa4601245823188', 1700234121978, '通知公告-添加通知', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('b9565332731f4348a866ed980a9b5b1c', 1700234100422, '通知公告-通过ID删除通知', '1', 'system_notice', '[\"e7bf3bd8117f44fd9f9741cac47c095a\"]', '127.0.0.1');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('1', 'super', '305cecf1eb10d0bcb1b0df2675535731', '超级管理', -1, 1642437031000, 1699937883063, 0, NULL);
