...
INSERT INTO `system_operation_log` VALUES ('076ac74402574429ba62632a6d40042b', 1708501946360, '系统字典-新增数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('0cc0b0d41098454aa5433374a92c1027', 1708508587840, '系统版本日志-新增数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('1207d077707b45038f83299b7d367405', 1708498511113, '系统账号管理-添加或更新人员账号', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('2515c24c0b0e4fa6b575a4e7861062c1', 1708501927899, '系统字典-新增数据', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('375eb29b3f4a4f68bc9b2f7b54bb1898', 1708503883599, '通知公告-添加通知', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('427ac79484774358a387c01900f218e5', 1708504089959, '通知公告-通过ID删除通知', '1', 'system_notice', '[\"d9d7b31773ed4f0e8c105ae6d76ffa2a\"]', '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('4e29965747244c22a6dada4eef47ed3e', 1708502514106, '系统字典-通过ID数组删除数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('50ef6c91fffd42cea0a4e7d8419c5ae1', 1708500045198, '系统字典-新增数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('5896279ba63a41d0ab0a6477473655ce', 1708589617986, '系统菜单资源-删除资源', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('6082e363576c48d4976feb8f452be1ce', 1707900985614, '系统字典-新增数据', '4', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('61deeb57277f42428e129491b01eb472', 1708504176497, '通知公告-通过ID删除通知', '1', 'system_notice', '[\"d9d7b31773ed4f0e8c105ae6d76ffa2a\"]', '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('6258d8e334f747ea9441e9a61cd8b0b2', 1708502082368, '系统字典-通过ID数组删除数据', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('71329b7a0d664adaa3d66cbe5440fcad', 1708575193614, '系统菜单资源-编辑或添加资源', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('745b0b69e8f242c18029b03dfc819eaf', 1708501934051, '系统字典-新增数据', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('a2100803be0a446281052d11f178db00', 1708500061826, '系统字典-通过ID数组删除数据', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('bbdc3715ec9041ab9edf113ce5938895', 1708504207197, '通知公告-添加通知', '1', NULL, NULL, '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('cfde9c92a7af4b94a8a498b5c8f5785c', 1708498513914, '系统账号管理-删除人员账号', '1', 'system_user', '[\"f8b3ea125c7df3753a39473376521642\"]', '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('e03ae23170944387b197c6fcbbdc7f98', 1708504217167, '通知公告-通过ID删除通知', '1', 'system_notice', '[\"48195a5f4ce74947ac88de37770e7864\"]', '127.0.0.1');
...
INSERT INTO `system_operation_log` VALUES ('eec318f91e9940ef9fb07b9264c10e23', 1708503124413, '系统字典-通过ID数组删除数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('f1319798dde448558af7d9b144b075a5', 1707830367603, '反馈类型-更新数据', '1', NULL, NULL, '127.0.0.1');
INSERT INTO `system_operation_log` VALUES ('fa986d91142141609242a096a5ea4f6f', 1708504075244, '通知公告-添加通知', '1', NULL, NULL, '127.0.0.1');
...
CREATE TABLE `system_resources`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 109 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单资源表' ROW_FORMAT = DYNAMIC;
